...
HIGH_SCORE_LIMIT = 10
HIGH_SCORE_NAME_LIMIT = 20
HIGH_SCORE_MESSAGE_LIMIT = 50
LEADERBOARD_URL = "https://app.antibesln.com/tag2_0/leaderboard/"
LEADERBOARD_TIMEOUT = 2.5
LEADERBOARD_SYNC_LIMIT = 2
LEADERBOARD_CACHE_TTL_SECONDS = 600.0
...
MALICE_BIRD_FORM_WINS = 3
MALICE_BONES_EXPLORER_LOSSES = 3
MALICE_ROBOTIC_WINS = 8
PACK_RUNNER_LAPS = 3
PERIMETER_MARGIN = 58
...
TRASHY_GUN_TARGET_HITS = 3
TRASHY_GUN_STUN_DURATION = 4.0
TRASHY_GUN_SHOT_SPEED = 720
TRASHY_GUN_SHOT_LIFETIME = 2.5
TRASHY_GUN_HOMING_STRENGTH = 5.0
